...
model_from_parameters{M <: Mode, A <: SGD}(model::SALSAModel{HINGE,A,M},params) = begin 
...
model_from_parameters{M <: Mode, A <: RDA}(model::SALSAModel{HINGE,A,M},params) = begin 
	model.dfunc = loss_derivative(model.loss_function) 
...
model_from_parameters{M <: Mode}(model::SALSAModel{HINGE,R_L1RDA,M},params) = begin 
    model.dfunc = loss_derivative(model.loss_function) 
...
ds_parameters_from_model(model::SALSAModel{HINGE,PEGASOS,LINEAR}) = [-5]
ds_parameters_from_model(model::SALSAModel{PINBALL,PEGASOS,LINEAR}) = [0,-5]
ds_parameters_from_model(model::SALSAModel{HINGE,DROP_OUT,LINEAR}) = [1]
ds_parameters_from_model(model::SALSAModel{PINBALL,DROP_OUT,LINEAR}) = [0,1]
ds_parameters_from_model{A <: RDA}(model::SALSAModel{HINGE,A,LINEAR}) = [-5;ones(2)]
ds_parameters_from_model{A <: RDA}(model::SALSAModel{PINBALL,A,LINEAR}) = [0;-5;ones(2)]
ds_parameters_from_model(model::SALSAModel{HINGE,R_L1RDA,LINEAR}) = [-5;ones(3)]
ds_parameters_from_model(model::SALSAModel{PINBALL,R_L1RDA,LINEAR}) = [0;-5;ones(3)]
ds_parameters_from_model(model::SALSAModel{HINGE,R_L2RDA,LINEAR}) = [-5,1,-2]
ds_parameters_from_model(model::SALSAModel{PINBALL,R_L2RDA,LINEAR}) = [0,-5,1,-2]

ds_parameters_from_model(model::SALSAModel{HINGE,PEGASOS,NONLINEAR}) = [-5;randn(1)]
ds_parameters_from_model(model::SALSAModel{PINBALL,PEGASOS,NONLINEAR}) = [0;-5;randn(1)]
ds_parameters_from_model(model::SALSAModel{HINGE,DROP_OUT,NONLINEAR}) = [1;randn(1)]
ds_parameters_from_model(model::SALSAModel{PINBALL,DROP_OUT,NONLINEAR}) = [0;1;randn(1)]
ds_parameters_from_model{A <: RDA}(model::SALSAModel{HINGE,A,NONLINEAR}) = [-5;ones(2);randn(1)]
ds_parameters_from_model{A <: RDA}(model::SALSAModel{PINBALL,A,NONLINEAR}) = [0;-5;ones(2);randn(1)]
ds_parameters_from_model(model::SALSAModel{HINGE,R_L1RDA,NONLINEAR}) = [-5;ones(3);randn(1)]
ds_parameters_from_model(model::SALSAModel{PINBALL,R_L1RDA,NONLINEAR}) = [0;-5;ones(3);randn(1)]
ds_parameters_from_model(model::SALSAModel{HINGE,R_L2RDA,NONLINEAR}) = [-5;1;-2;randn(1)]
